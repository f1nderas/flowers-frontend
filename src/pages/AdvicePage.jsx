...
const items = [
  {
    id: 1,
    text: "после того, как букет окажется дома, необходимо: дать цветам полежать 15-20 минут, особенно это актуально в зимнее время года - так растения быстрее адаптируются к новым условиям.",
  },
  {
    id: 2,
    text: "налить в чистую вазу воды, комнатной температуры или не слишком холодную. Лучше брать отстоянную. Очистить стебли от нижних листьев, так как их нахождение в воде приводит к ее быстрому закисанию.",
  },
  {
    id: 3,
    text: "стебли подрезать, сделать косой срез - так цветок больше берет воды. Менять воду ежедневно, а в жаркие дни и два раза в сутки. Перед сменой воды вазу обязательно нужно промывать.",
  },
  {
    id: 4,
    text: "разместить вазу с цветами лучше в прохладном помещении, без сквозняков, без прямых солнечных лучей. Если влажность не высокая, то можно периодически опрыскивать листву, но ни в коем случае не попадая на бутоны.",
  },
  {
    id: 5,
    text: "не рекомендуется цветы держать рядом с овощами и фруктами - так как они выделяют этилен, ускоряющий увядание.",
  },
];
          ...
          <div className="advice">
            ...
            <div className="advice-right">
              ...
              <ul className="custom-list">
                {items.map((product) => {
                  return (
                    <li key={product.id} className="custom-list_item">
                      <Check className="custom-list_icon" />
